...
In Fantasy Premier League (FPL), chips are special power-ups that managers can use strategically throughout the season to boost their team's performance. Each manager gets a limited number of chips that can only be used once per season.
The Four Main Chips in FPL:

1. Wildcard

What it does: Allows unlimited free transfers for one gameweek
How many: You get 2 wildcards per season (one before January 1st, one after)
Best used: During international breaks, fixture congestion, or when your team needs major restructuring

2. Bench Boost

What it does: Points from all 4 bench players are added to your total score
How many: 1 per season
Best used: During Double Gameweeks when many players have 2 fixtures, maximizing potential points from your entire 15-man squad

3. Triple Captain

What it does: Your captain gets 3x points instead of the usual 2x
How many: 1 per season
Best used: On a player with a Double Gameweek (2 fixtures) who you're confident will score big

4. Free Hit

What it does: Make unlimited transfers for one gameweek, then your team reverts back to how it was before
How many: 1 per season
Best used: During Blank Gameweeks when many of your players don't have fixtures, or for Double Gameweeks

Strategic Timing:
The key to FPL success is knowing when to use these chips. Most experienced managers save them for:

Double Gameweeks (when teams play twice)
Blank Gameweeks (when many teams don't play)
Fixture swings (when easy/difficult fixtures change)

Based on the FPL API data I can access, I can see that the system tracks chip usage - in the bootstrap-static data, there's a chip_plays array that shows how many managers have used each chip type (like "bboost" for Bench Boost and "3xc" for Triple Captain).
